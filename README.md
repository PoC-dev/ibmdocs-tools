...
### The database
Multiple tables accomodate metadata for eventual creation of the index page:
...
DDS descriptions for the files are found in the as400 subdirectory.
