     ...
     H*     36: Hide DATE_ADDED in SFL if NULL.
     ...
     FIBMDOCTYPFUF A E           K DISK    INFDS(FINFDS)
     F*
     ...
     FIBMDOCTYL1IF   E           K DISK
     FIBMDOCTYL2IF   E           K DISK
     FIBMDOCTYL3IF   E           K DISK
     F*
     F* Display file with multiple subfiles among other record formats.
     FIBMDOCTYDFCF   E             WORKSTN
     ...
     D*  different kind).
     DT_DOCTYPTBL    E DS                  EXTNAME(IBMDOCTYPF:DOCTYPTBL) INZ
     ...
     D C_DOCTYPE                           LIKE(DOCTYPE)
     D C_DATE_ADDED                        LIKE(DATE_ADDED)
     D C_DLSNAME                           LIKE(DLSNAME)
     D*
     ...
     C     SORTKEY       WHENEQ    1
     C                   MOVEL     *BLANK        C_DATE_ADDED
     C                   MOVEL     POSTO         C_DATE_ADDED
     C     C_DATE_ADDED  SETLL     FWDPOS2                            72
     C     SORTKEY       WHENEQ    2
     C                   MOVEL     *BLANK        C_DLSNAME
     C                   MOVEL     POSTO         C_DLSNAME
     C     C_DLSNAME     SETLL     FWDPOS3                            72
     C                   ENDSL
     C*
     ...
     C                   CLEAR                   C_DOCTYPTBL
     C                   MOVEL     T_DOCTYPTBL   C_DOCTYPTBL
     C*
     ...
     C                   EVAL      T_DOCTYPTBL = C_DOCTYPTBL
     ...
     C                   SELECT
     C     SORTKEY       WHENEQ    *ZERO
     C     SORTKEY1      SETLL     FWDPOS1                            72
     C     SORTKEY       WHENEQ    1
     C     SORTKEY2      SETLL     FWDPOS2                            72
     C     SORTKEY       WHENEQ    2
     C     SORTKEY3      SETLL     FWDPOS3                            72
     C                   ENDSL
     C                   ENDIF
     C*
     ...
     C                   SELECT
     C     SORTKEY       WHENEQ    *ZERO
     C     SORTKEY1      SETLL     FWDPOS1
     C     SORTKEY       WHENEQ    1
     C     SORTKEY2      SETLL     FWDPOS2
     C     SORTKEY       WHENEQ    2
     C     SORTKEY3      SETLL     FWDPOS3
     C                   ENDSL
     C                   EXSR      LOADDSPSFL
     C                   MOVE      *OFF          *IN35
     C                   ELSE
     ...
     C                   MOVE      *ON           *IN(DSPFUL)
     C*
     C* Provide Keylist for record matching when updating.
     C     SORTKEY1      KLIST
     C                   KFLD                    DOCNBR
     C                   KFLD                    DOCTYPE
     C*
     ...
     C*
     C* Delete record.
     C     SORTKEY1      DELETE(E) DOCTYPTBL
     C                   EVAL      FSTAT=%STATUS(IBMDOCTYPF)
     C     FSTAT         IFGT      *ZERO
     C                   EXSR      SETERRIND
     C                   MOVE      *ON           *IN99
     C                   UPDATE    DLTSFL
     ...
     C     *IN78         IFEQ      *ON
     C     SORTKEY1      CHAIN(EN) DOCTYPTBL
     C                   ELSE
     C     SORTKEY1      CHAIN(E)  DOCTYPTBL
     C                   ENDIF
     C*
     C                   EVAL      FSTAT=%STATUS(IBMDOCTYPF)
     C     FSTAT         IFGT      *ZERO
     ...
     C                   MOVE      *ON           *IN60
     C     CSFLD         WHENEQ    'DOCTYPE'
     C                   MOVE      *ON           *IN61
     C     CSFLD         WHENEQ    'DATE_ADDED'
     C                   MOVE      *ON           *IN62
     C     CSFLD         WHENEQ    'DLSNAME'
     C                   MOVE      *ON           *IN63
     C                   ENDSL
     C                   ENDIF
     C*
     ...
     C                   ENDIF
     C*
     C                   IF        %NULLIND(DLSNAME)
     C                   MOVEL     *BLANK        DLSNAME
     C                   ENDIF
     C*
     C                   ENDSR
     C*************************************************************************
     ...
     C*  compiler flags!
     C*
     C     DATE_ADDED    IFEQ      '01.01.01'
     C                   EVAL      %NULLIND(DATE_ADDED) = *ON
     C                   ENDIF
     C     DLSNAME       IFEQ      *BLANK
     C                   EVAL      %NULLIND(DLSNAME) = *ON
     C                   ENDIF
     C*
     C                   ENDSR
     C*************************************************************************
